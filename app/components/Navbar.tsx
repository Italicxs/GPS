            ...
            <div className="flex justify-between h-16">
              <div className="flex justify-between w-full">
                <div className="flex items-center">
                  <Link href="/">
                    <div className="w-32 h-16 flex-col justify-start items-start inline-flex mt-5">
                    <div className="text-center text-blue-500 text-red-rose text-2xl font-bold leading-normal tracking-tight">
                        GPS
                      </div>
                      <div className="text-center text-blue-500 text-sm font-normal leading-none">
